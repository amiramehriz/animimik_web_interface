...
def main(config, checkpoint = 'vox-cpk.pth.tar', source_image = 'sup-mat/source.png',
         driving_video ='sup-mat/source.png', result_video = 'result.mp4', relative =  False,
         adapt_scale = False, find_best_frame = None, best_frame = None, cpu = None):
